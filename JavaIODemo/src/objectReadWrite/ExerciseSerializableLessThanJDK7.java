...
public class ExerciseSerializableLessThanJDK7 {
	...
	private static final Logger fLogger = Logger.getLogger(ExerciseSerializableLessThanJDK7.class.getPackage().getName());
