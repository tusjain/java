 ...
 * 
 */
@WebServiceClient(name = "SayHelloService", targetNamespace = "http://wsServer.myfirst.com/", wsdlLocation = "http://localhost:8080/wsServerExample?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOSERVICE_QNAME = new QName("http://wsServer.myfirst.com/", "SayHelloService");
    ...
    public SayHello getSayHelloPort() {
        return super.getPort(new QName("http://wsServer.myfirst.com/", "SayHelloPort"), SayHello.class);
    }
    ...
    public SayHello getSayHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wsServer.myfirst.com/", "SayHelloPort"), SayHello.class, features);
    }
